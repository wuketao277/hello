export default {
  ...
  calcDate (type) {
    ...
    if (type === 'week') {
      ...
      startDate = new Date(Date.parse(year + '-' + month + '-01 16:00:00', 'yyyy-MM-dd HH:mm:ss'))
      if (month === 2) {
        // 2 月
        endDate = new Date(Date.parse(year + '-' + month + '-28 16:00:00', 'yyyy-MM-dd HH:mm:ss'))
      } else if (month === 1 || month === 3 || month === 5 || month === 7 || month === 8 || month === 10 || month === 12) {
        // 1 3 5 7 8 10 12月
        endDate = new Date(Date.parse(year + '-' + month + '-31 16:00:00', 'yyyy-MM-dd HH:mm:ss'))
      } else {
        // 4 6 9 11月
        endDate = new Date(Date.parse(year + '-' + month + '-30 16:00:00', 'yyyy-MM-dd HH:mm:ss'))
      }
    } else if (type === 'month') {
      let month = new Date().getMonth() + 1
      startDate = new Date(Date.parse(new Date().getFullYear() + '-' + month + '-01 16:00:00', 'yyyy-MM-dd HH:mm:ss'))
      if (month === 2) {
        // 2 月
        endDate = new Date(Date.parse(new Date().getFullYear() + '-' + month + '-28 16:00:00', 'yyyy-MM-dd HH:mm:ss'))
      } else if (month === 1 || month === 3 || month === 5 || month === 7 || month === 8 || month === 10 || month === 12) {
        // 1 3 5 7 8 10 12月
        endDate = new Date(Date.parse(new Date().getFullYear() + '-' + month + '-31 16:00:00', 'yyyy-MM-dd HH:mm:ss'))
      } else {
        // 4 6 9 11月
        endDate = new Date(Date.parse(new Date().getFullYear() + '-' + month + '-30 16:00:00', 'yyyy-MM-dd HH:mm:ss'))
      }
      ...
      if (month === 1 || month === 2 || month === 3) {
        startDate = new Date(Date.parse(year + '-01-01 16:00:00', 'yyyy-MM-dd HH:mm:ss'))
        endDate = new Date(Date.parse(year + '-03-31 16:00:00', 'yyyy-MM-dd HH:mm:ss'))
      } else if (month === 4 || month === 5 || month === 6) {
        startDate = new Date(Date.parse(year + '-04-01 16:00:00', 'yyyy-MM-dd HH:mm:ss'))
        endDate = new Date(Date.parse(year + '-06-30 16:00:00', 'yyyy-MM-dd HH:mm:ss'))
      } else if (month === 7 || month === 8 || month === 9) {
        startDate = new Date(Date.parse(year + '-07-01 16:00:00', 'yyyy-MM-dd HH:mm:ss'))
        endDate = new Date(Date.parse(year + '-09-30 16:00:00', 'yyyy-MM-dd HH:mm:ss'))
      } else if (month === 10 || month === 11 || month === 12) {
        startDate = new Date(Date.parse(year + '-10-01 16:00:00', 'yyyy-MM-dd HH:mm:ss'))
        endDate = new Date(Date.parse(year + '-12-31 16:00:00', 'yyyy-MM-dd HH:mm:ss'))
      }
    } else if (type === 'season') {
      let month = new Date().getMonth() + 1
      if (month === 1 || month === 2 || month === 3) {
        startDate = new Date(Date.parse(new Date().getFullYear() + '-01-01 16:00:00', 'yyyy-MM-dd HH:mm:ss'))
        endDate = new Date(Date.parse(new Date().getFullYear() + '-03-31 16:00:00', 'yyyy-MM-dd HH:mm:ss'))
      } else if (month === 4 || month === 5 || month === 6) {
        startDate = new Date(Date.parse(new Date().getFullYear() + '-04-01 16:00:00', 'yyyy-MM-dd HH:mm:ss'))
        endDate = new Date(Date.parse(new Date().getFullYear() + '-06-30 16:00:00', 'yyyy-MM-dd HH:mm:ss'))
      } else if (month === 7 || month === 8 || month === 9) {
        startDate = new Date(Date.parse(new Date().getFullYear() + '-07-01 16:00:00', 'yyyy-MM-dd HH:mm:ss'))
        endDate = new Date(Date.parse(new Date().getFullYear() + '-09-30 16:00:00', 'yyyy-MM-dd HH:mm:ss'))
      } else if (month === 10 || month === 11 || month === 12) {
        startDate = new Date(Date.parse(new Date().getFullYear() + '-10-01 16:00:00', 'yyyy-MM-dd HH:mm:ss'))
        endDate = new Date(Date.parse(new Date().getFullYear() + '-12-31 16:00:00', 'yyyy-MM-dd HH:mm:ss'))
      }
      ...
      startDate = new Date(Date.parse('2019-01-01 16:00:00', 'yyyy-MM-dd HH:mm:ss'))
      endDate = new Date()
