    ...
    <el-form ref="form"
      ...
      <el-row :gutter="12">
        ...
        <el-col :span="4">
          ...
          <span style="color:#F56C6C;" v-show="schoolTypeTag !== '公办'">“{{undergraduateName}}” 是 {{schoolTypeTag}}；</span>
        </el-col>
        <el-col :span="2">
          <el-button type="primary"
                     size="mini"
      ...
      <el-row :gutter="12">
        ...
        <el-col :span="16">
          <el-collapse style="border-width:0px;margin:0px;padding:0px;">
        ...
        <el-col :span="8">
          <el-form-item label="客户属性标签">
            ...
            <el-button type="success"
                       size="mini"
                       icon="el-icon-circle-plus"
                       @click="addCandidateClientRepeatedLabel">添加</el-button>
            <el-button type="danger"
                       size="mini"
                       icon="el-icon-remove-outline"
                       @click="deleteCandidateClientRepeatedLabel">删除</el-button>
          </el-form-item>
        </el-col>
        <el-col :span="16">
          <el-collapse style="border-width:0px;margin:0px;padding:0px;">
            <el-collapse-item title="下拉展示所有标签"
                              name="1"
                              style="border-width:0px;margin:0px;padding:0px;">
              <el-checkbox-group v-model="form.candidateClientRepeatedLabels"
                                 @change="handleCandidateClientRepeatedLabelsChange">
                <el-checkbox v-for="label in allCandidateClientRepeatedLabels"
                             :label="label"
                             :key="label">{{label}}</el-checkbox>
              </el-checkbox-group>
            </el-collapse-item>
    ...
    <el-tabs type="border-card">
      ...
      <el-tab-pane label="推荐职位/评论">
        ...
        <el-table highlight-current-row
          ...
          <el-table-column prop="createUserName" label="推荐人" width="80">
          </el-table-column>
        </el-table>
        <!--职位列表结束-->
        <br />
