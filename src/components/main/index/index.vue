    ...
    <el-container>
      <el-aside style="width:160px;">
        <el-menu default-active="2"
          ...
          <el-menu-item index="/case/caselist"
          ...
          <el-submenu index="/salary"
            ...
            <el-menu-item index="/salary/salarySpecialItemList"
