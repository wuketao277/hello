<template>
  <div>
    ...
    <div class="toolbar">
      ...
      <el-button type="primary" size="small" icon="el-icon-edit-outline" @click="study">学 习</el-button>
    ...
    <template>
      ...
      >
        ...
        <el-table-column prop="teacherUserName" width="200" label="课程老师"></el-table-column>
      </el-table>
      <el-pagination
        background
