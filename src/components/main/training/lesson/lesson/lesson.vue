<template>
  <div>
    <el-breadcrumb separator-class="el-icon-arrow-right" style="margin-bottom:20px;">
      ...
      <el-breadcrumb-item :to="{ path: '/training/lessonlist'}">课程列表</el-breadcrumb-item>
    ...
    <div v-show="mode === 'study'">
      <div class="toolbar">
        ...
        <el-button
          ...
          @click="finishStudy"
        >学习完成</el-button>
        <span v-show="finishStatus" style="color:#67C23A">本课程已完成</span>
      </div>
    ...
    <div v-show="mode !== 'study'">
      ...
      <div v-show="false">
        ...
        >
          <el-row :gutter="12">
            <el-col :span="20">
              <el-form-item label="问题名称" prop="lessonQuestionContent">
                <el-input
                  type="textarea"
        ...
        <div class="toolbar">
          <el-button
            ...
            size="mini"
            icon="el-icon-delete"
            @click="deleteLessonQuestionById"
          >删 除</el-button>
        </div>
        <el-table
          :data="table.content"
        ...
        >
          ...
          <el-table-column prop="lessonQuestionContent" label="问题内容" show-overflow-tooltip></el-table-column>
        </el-table>
        <el-pagination
          background
