<template>
  <div>
    <el-breadcrumb separator-class="el-icon-arrow-right"
      ...
      <el-breadcrumb-item :to="{ path: '/background.html/mynews/mynewslist' }">我的新闻</el-breadcrumb-item>
    ...
    <el-form ref="form"
      ...
      <el-form-item label="优先级"
                    style="text-align:left;">
        <template>
          <el-radio v-model="form.priority"
                    label="1">非常重要</el-radio>
          <el-radio v-model="form.priority"
                    label="2">重要</el-radio>
          <el-radio v-model="form.priority"
                    label="3">一般</el-radio>
          <el-radio v-model="form.priority"
                    label="4">不重要</el-radio>
          <el-radio v-model="form.priority"
                    label="5">可忽略</el-radio>
        </template>
      </el-form-item>
