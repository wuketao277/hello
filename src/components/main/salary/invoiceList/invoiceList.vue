<template>
  <div>
    ...
    <div class="toolbar">
      ...
      <br />
      <span>待付款金额：{{noPaymentSum}}</span>&nbsp;&nbsp;&nbsp;&nbsp;<span>待开票金额：{{noInvoiceSum}}</span>&nbsp;&nbsp;&nbsp;&nbsp;<span>合计：{{(noPaymentSum+noInvoiceSum).toFixed(2)}}</span>
    </div>
    <template>
          ...
          <el-row :gutter="20">
            ...
            <el-col :span="12">
              <el-form-item label="正常/作废">
                <el-switch v-model="search.status"
                           active-color="#13ce66"
