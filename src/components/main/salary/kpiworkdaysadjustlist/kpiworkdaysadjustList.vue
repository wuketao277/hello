<template>
  <div>
    <el-breadcrumb separator-class="el-icon-arrow-right"
      ...
      <el-breadcrumb-item>KPI工作日调整列表</el-breadcrumb-item>
    </el-breadcrumb>
    <div class="toolbar">
    ...
    <template>
      <el-table :data="table.content"
        ...
        <el-table-column prop="userName"
                         ...
                         label="用户"
                         show-overflow-tooltip></el-table-column>
        <el-table-column prop="adjustDate"
                         :formatter="formatDate"
                         width="120"
                         label="调整日期"
                         show-overflow-tooltip></el-table-column>
        <el-table-column prop="adjustDays"
                         width="120"
                         label="调整天数"
                         show-overflow-tooltip></el-table-column>
...
<script src="./kpiworkdaysadjustList.js"></script>
