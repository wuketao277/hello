<template>
  <div>
    <el-breadcrumb separator-class="el-icon-arrow-right" style="margin-bottom:20px;">
      ...
      <el-breadcrumb-item :to="{ path: '/salary/invoiceList'}">发票列表</el-breadcrumb-item>
      ...
      <el-row :gutter="20">
        ...
        <el-col :span="6">
          <el-form-item label="发票金额" required>
            <el-input v-model="form.sum" clearable style="width:100%;"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="6">
        ...
        <el-col :span="6">
          <el-form-item label="品名" required>
            <el-input v-model="form.kind" clearable style="width:100%;"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row :gutter="20">
      ...
      <el-row :gutter="20">
        <el-col :span="6">
          <el-form-item label="PO">
            <el-input v-model="form.po" clearable></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="6">
    ...
    <el-dialog title="选择顾问" :visible.sync="selectAMDialogShow">
      <selectUser
        v-on:cancel-dialog="selectAMDialogShow = false"
        v-on:sure-dialog="sureSelectAMDialog"
      ></selectUser>
    </el-dialog>
  </div>
</template>
