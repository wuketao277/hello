<template>
  <div>
    <el-breadcrumb separator-class="el-icon-arrow-right"
      ...
      <el-breadcrumb-item :to="{ path: '/background.html/salary/salarySpecialItemList'}">工资特殊项列表</el-breadcrumb-item>
      ...
      <el-row :gutter="12">
        <el-col :span="6">
          <el-button type="primary"
                     size="small"
                     icon="el-icon-share"
                     @click="openSelectConsultantDialog">顾问</el-button>
