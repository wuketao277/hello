<template>
  <div>
    ...
    >
      ...
      <el-table-column type="selection" width="50" v-if="showControl('selectionColumn')"></el-table-column>
      ...
      <el-table-column prop="holidayDate" label="请假日期" :formatter="formatDate" width="100"></el-table-column>
      <el-table-column prop="holidayLong" label="请假时长" width="100"></el-table-column>
      <el-table-column prop="approveStatus" label="审批状态" width="100"></el-table-column>
