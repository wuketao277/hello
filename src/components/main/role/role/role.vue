<template>
  <div>
    <el-breadcrumb separator-class="el-icon-arrow-right" style="margin-bottom:20px;">
      ...
      <el-breadcrumb-item :to="{ path: '/role/rolelist' }">角色列表</el-breadcrumb-item>
    ...
    <div class="toolbar" v-show="(mode === 'add' || mode === 'modify')">
      <el-button type="success" size="small" icon="el-icon-circle-check" @click="saveRole">保 存</el-button>
