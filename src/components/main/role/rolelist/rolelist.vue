  ...
  <div>
    ...
    <div class="toolbar">
      ...
      <el-button type="primary"
                 ...
                 @click="detailRole">查看</el-button>
      <el-button type="warning"
                 size="small"
                 icon="el-icon-edit"
                 @click="modifyRole">修改</el-button>
      ...
      <el-button type="primary"
                 size="small"
                 icon="el-icon-search"
                 @click="switchSearchDialog">搜索</el-button>
    </div>
    <el-form v-if="search.show"
    ...
    <el-pagination background
                   ...
                   :page-size="table.pageable.pageSize"></el-pagination>
    <!--搜索对话框-->
    <el-dialog title="搜索"
