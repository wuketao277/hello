...
export default {
  ...
  methods: {
    ...
    save() {
      ...
      if (this.form.caseId === '' && (this.form.type === 'perm' || this.form.type === 'contracting')) {
        // 猎头、外包，必须选择职位
        this.$message({
          message: '职位必选！',
          type: 'warning',
      ...
      if (this.form.candidateId === '' && (this.form.type === 'perm' || this.form.type === 'contracting')) {
        // 猎头、外包，必须选择候选人
        this.$message({
          message: '候选人必选！',
          type: 'warning',
      ...
      if (this.form.gp === '' && (this.form.type === 'perm' || this.form.type === 'contracting' || this.form.type === 'consultation' || this.form.type === 'coach')) {
        // 猎头、外包、咨询、培训，必须填写GP
        this.$message({
          message: 'GP不能为空！',
          type: 'warning',
    ...
    billingReadonly: function () {
      ...
      if (commonJS.isAdmin()) {
        ...
        if (this.form.clientId === 83128 ||
          this.form.clientId === 116400 ||
          this.form.clientId === 506794 ||
          this.form.clientId === 530067 ||
          this.form.clientId === 534813 ||
          this.form.clientId === 536829 ||
          this.form.clientId === 551408 ||
          this.form.clientId === 554065 ||
          this.form.clientId === 561173 ||
          this.form.clientId === 562083 ||
          this.form.clientId === 565134 ||
          this.form.clientId === 565142 ||
          this.form.clientId === 567055 ||
          this.form.clientId === 567056 ||
